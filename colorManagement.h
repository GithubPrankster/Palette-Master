...
struct Palette{
    ...
    MixPlan deviseColorPlan(TrueColor original){
        ...
        for(uint8_t index1 = 0; index1 < 16; index1++){
            for(uint8_t index2 = index1; index2 < 16; index2++){
                ...
                uint8_t r0 = color1.R + ratio * (int)(color2.R - color1.R) / 64;
                uint8_t g0 = color1.G + ratio * (int)(color2.G - color1.G) / 64;
                uint8_t b0 = color1.B + ratio * (int)(color2.B - color1.B) / 64;
                ...
                if(index1 != index2){
                    for(uint8_t index3 = 0; index3 < 16; index3++){
...
void writeRenderPalettized(Palette pal, uint8_t* data, uint16_t imgWidth, uint16_t imgHeight, uint8_t imgDepth){
